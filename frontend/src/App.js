  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Information Section */}
        <div className="mt-12 bg-white rounded-xl shadow-lg p-8 border-l-4 border-blue-500">
              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
                ...
                <div className="space-y-3 text-blue-800">
                  <p className="flex items-start">
                    ...
                    Los chatbots automatizan típicamente <strong>60% a 80%</strong> de las consultas de clientes
                  </p>
                  <p className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Ahorro promedio de <strong>3 a 5 minutos por consulta</strong>
                  </p>
                  <p className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Resultado: <strong>cientos de horas ahorradas por año</strong> para PyMEs
                  </p>
                </div>
              ...
              <div className="bg-green-50 rounded-lg p-6 border border-green-100">
                ...
                <div className="space-y-3 text-green-800">
                  <p className="flex items-start">
                    ...
                    Automatiza tareas administrativas, de ventas y soporte
                  </p>
                  <p className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Reduce la carga manual en <strong>30% a 50%</strong> en promedio
                  </p>
                  <p className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    Mejora significativa en seguimiento y reportes automáticos
                  </p>
                </div>
            ...
            <div className="mt-8 bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl font-bold text-blue-600 mb-1">60-80%</div>
                  <div className="text-sm text-gray-600">Consultas automatizables</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl font-bold text-green-600 mb-1">30-50%</div>
                  <div className="text-sm text-gray-600">Reducción carga CRM</div>
                </div>
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="text-2xl font-bold text-purple-600 mb-1">3-5 min</div>
                  <div className="text-sm text-gray-600">Ahorro por consulta</div>
                </div>
              </div>
            </div>
          </div>
